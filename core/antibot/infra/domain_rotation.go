...
func NewDomainRotationManager(config *DomainRotationConfig) *DomainRotationManager {
...
func (drm *DomainRotationManager) AddDomain(domain string, subdomain string, dnsProvider string) error {
	...
	// TLS Certificates are requested by the HTTP Proxy layer
...
// requestCertificate functionality removed: handled externally by HTTP Proxy.
